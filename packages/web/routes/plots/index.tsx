...
// プロット管理ページを表示する
const PlotsPage = () => {
  const { scenarios, isLoading, errorMessage } = useScenarios()
  ...
  return (
    <PageContainer>
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center gap-3 rounded-xl border border-dashed border-destructive/40 py-16 text-center">
